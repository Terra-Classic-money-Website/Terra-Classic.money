...
export const protocols = [
  {
    ...
    image: "protocol-staking.png",
    ui: ["protocol-validator-ui.png", "protocol-staking-ui.png"],
  ...
  },
  {
    ...
    image: "protocol-swap.png",
    ui: ["protocol-swap-ui.png"],
  ...
  },
  {
    ...
    image: "protocol-forex.png",
    ui: ["protocol-deposit-ui.png", "protocol-mint-ui.png"],
...
export const assets = [
  { code: "EUTC", name: "Terra Classic Euro", phase: 1 },
  { code: "HKTC", name: "Terra Classic Hong Kong Dollar", phase: 2 },
  { code: "NOTC", name: "Terra Classic Norwegian Krone", phase: 2 },
  { code: "PHTC", name: "Terra Classic Philippine Peso", phase: 2 },
  { code: "HKTC", name: "Terra Classic Australian Dollar", phase: 3 },
  { code: "CATC", name: "Terra Classic Canadian Dollar", phase: 3 },
  { code: "CHTC", name: "Terra Classic Swiss Franc", phase: 3 },
  { code: "CNTC", name: "Terra Classic Chinese Yuan Renminbi", phase: 3 },
  { code: "DKTC", name: "Terra Classic Danish Krone", phase: 3 },
  { code: "GBTC", name: "Terra Classic British Pound Sterling", phase: 3 },
  { code: "INTC", name: "Terra Classic Indian Rupee", phase: 3 },
  { code: "IDTC", name: "Terra Classic Indonesian Rupiah", phase: 3 },
  { code: "JPTC", name: "Terra Classic Japanese Yen", phase: 3 },
  { code: "KRTC", name: "Terra Classic South Korean Won", phase: 3 },
  { code: "MNTC", name: "Terra Classic Mongolian Tögrög", phase: 3 },
  { code: "MYTC", name: "Terra Classic Malaysian Ringgit", phase: 3 },
  { code: "SDTC", name: "Terra Classic Special Drawing Rights", phase: 3 },
  { code: "SETC", name: "Terra Classic Swedish Krona", phase: 3 },
  { code: "SGTC", name: "Terra Classic Singapore Dollar", phase: 3 },
  { code: "THTC", name: "Terra Classic Thai Baht", phase: 3 },
  { code: "TWTC", name: "Terra Classic New Taiwan Dollar", phase: 3 },
  { code: "USTC", name: "Terra Classic US Dollar", phase: 4 },
];
